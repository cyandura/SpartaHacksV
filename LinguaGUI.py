...
R5 = Radiobutton(saveandconvertframe, text='.TXT', variable=v, value=5,command = lambda : txt()).grid(row=1,column=1)

R6 = Radiobutton(recordframe, text='.PDF', variable=v, value=6, command = lambda : pdf()).grid(row=2,column=0)

R8 = Radiobutton(recordframe, text='.TXT', variable=v, value=8,command = lambda : txt()).grid(row=2,column=1)
